...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	tianma_dcs_write_seq_static(ctx, 0xB6, 0x59, 0x00, 0x06, 0x23, 0x8A,
...
static const struct of_device_id tianma_of_match[] = {
	{
		.compatible = "tianma,r66451,cmd,no-mipi-switch",
	},
	{} };
...
static struct mipi_dsi_driver tianma_driver = {
	...
	.driver = {
			...
			.name = "panel-tianma-r66451-cmd-no-mipi-switch",
			.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("tianma r66451 CMD no mipi switch AMOLED Panel Driver");
