...
#include "include/panel-tianma-r66451-cmd-120hz-no-mipi-switch.h"
#endif
...
static const struct of_device_id tianma_of_match[] = {
	{
		.compatible = "tianma,r66451,cmd,120hz,no-mipi-switch",
	},
	{} };
...
static struct mipi_dsi_driver tianma_driver = {
	...
	.driver = {
			...
			.name = "panel-tianma-r66451-cmd-120hz-no-mipi-switch",
			.owner = THIS_MODULE,
