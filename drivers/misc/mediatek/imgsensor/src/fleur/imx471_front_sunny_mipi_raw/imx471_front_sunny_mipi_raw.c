...
#include "imx471_front_sunny_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = IMX471_FRONT_SUNNY_SENSOR_ID,
...
kal_uint16 addr_data_pair_custom1_imx471_sunny[] = {	// full size 4656x3496
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx471_sunny_table_write_cmos_sensor(addr_data_pair_custom1_imx471_sunny,
		sizeof(addr_data_pair_custom1_imx471_sunny) / sizeof(kal_uint16));
}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1455400;
		break;
...
UINT32 IMX471_FRONT_SUNNY_MIPI_RAW_SensorInit(
