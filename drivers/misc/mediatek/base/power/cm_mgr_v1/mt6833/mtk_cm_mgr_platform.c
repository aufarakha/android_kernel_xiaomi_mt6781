...
int pm_qos_update_request_status;  /* original local variable used in common code */
...
static void cm_mgr_ratio_timer_fn(struct timer_list * data)
{
	int i;
...
/* kernel-4.19 obsolete code replaced by timer_setup
