...
#include "sspm_ipi_define_mt6765.h"
#include "sspm_reservedmem_define_mt6765.h"
#include "sspm_timesync.h"

static struct workqueue_struct *mt6765_sspm_workqueue;
static atomic_t sspm_inited = ATOMIC_INIT(0);

static int __init mt6765_sspm_module_init(void)
{
	...
	mt6765_sspm_workqueue = create_workqueue("mt6765-SSPM_WQ");

	if (!mt6765_sspm_workqueue) {
...
static int __init mt6765_sspm_probe(struct platform_device *pdev)
{
	struct resource *res;
	...
	mbox_table = mt6765_mbox_table;
	send_pintable = mt6765_send_pintable;
	recv_pintable = mt6765_recv_pintable;
	pin_name = mt6765_pin_name;
...
#ifdef CONFIG_PM
static int mt6765_sspm_suspend(struct device *dev)
{
	sspm_timesync_suspend();
	return 0;
}

static int mt6765_sspm_resume(struct device *dev)
{
	sspm_timesync_resume();
	return 0;
}

static const struct dev_pm_ops mt6765_sspm_dev_pm_ops = {
	.suspend = mt6765_sspm_suspend,
	.resume  = mt6765_sspm_resume,
};
#endif

static const struct of_device_id mt6765_sspm_of_match[] = {
	{ .compatible = "mediatek,mt6765-sspm", },
	{},
};

static const struct platform_device_id mt6765_sspm_id_table[] = {
	{ "mt6765-sspm", 0},
	{ },
};

static struct platform_driver mtk_mt6765_sspm_driver __refdata = {
	.probe  = mt6765_sspm_probe,
	.remove = NULL,
	.shutdown = NULL,
	.suspend = NULL,
	.resume = NULL,
	.driver = {
		.name = "mt6765-sspm",
		.owner = THIS_MODULE,
		.of_match_table = mt6765_sspm_of_match,
#ifdef CONFIG_PM
		.pm = &mt6765_sspm_dev_pm_ops,
#endif
	},
...
subsys_initcall(mt6765_sspm_init);
module_exit(mt6765_sspm_exit);
