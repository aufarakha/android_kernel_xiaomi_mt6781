...
static void nvt_print_criteria(void)
{
	...
	pr_debug("PS_Config_Lmt_Short_Rawdata_P:\n");
	nvt_print_lmt_array(PS_Config_Lmt_Short_Rawdata_P, X_Channel, Y_Channel);
	pr_debug("PS_Config_Lmt_Short_Rawdata_N:\n");
