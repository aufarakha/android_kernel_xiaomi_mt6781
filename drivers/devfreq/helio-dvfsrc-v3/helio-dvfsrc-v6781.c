		...
		struct device_attribute *attr, char *buf)
{
	...
	return sprintf(buf, "rising 15 uS, falling 30 uS for mt6781\n");
}
static DEVICE_ATTR(dvfsrc_vcore_settle_time, 0444,
		dvfsrc_vcore_settle_time_show, NULL);

static struct attribute *mt6781_helio_dvfsrc_attrs[] = {
	&dev_attr_dvfsrc_vcore_settle_time.attr,
	NULL,
};

static struct attribute_group mt6781_helio_dvfsrc_attr_group = {
	.name = "helio-dvfsrc",
	.attrs = mt6781_helio_dvfsrc_attrs,
};
...
void helio_dvfsrc_platform_init(struct helio_dvfsrc *dvfsrc)
{
	...
	sysfs_merge_group(&dvfsrc->dev->kobj, &mt6781_helio_dvfsrc_attr_group);
...
#elif defined(CONFIG_MEDIATEK_DRAMC)
